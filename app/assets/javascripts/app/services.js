angular.module('movieRoomApp.services', [])
  .service('MoviesService', 
    function($http, $q){
      this.movies = function(name){
        ...
        $http({
          method: 'GET',
          url: "http://gdata.youtube.com/feeds/api/charts/movies/most_popular?v=2&max-results=10&paid-content=true&hl=en&region=us&alt=json"
        }).
